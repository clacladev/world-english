...
**Rule.** Keep the order **Subject → Verb → Object**. Avoid fronting, inversion, and
clefting for emphasis; use plain word choice or a marker instead.

**Problem it solves.** Free-word-order flexibility and inversion (see
[§8](../resources/IRREGULARITIES.md#8-sentence-structure)) are a trap for learners from
