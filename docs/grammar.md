...
> Fixes [§4 Countability](../resources/IRREGULARITIES.md#4-noun-plurals--countability),
> [§6 Pronouns](../resources/IRREGULARITIES.md#6-pronouns),
> [§7 Grammar systems](../resources/IRREGULARITIES.md#7-grammar-systems-articles-prepositions-tense-phrasal-verbs),
> [§8 Sentence structure](../resources/IRREGULARITIES.md#8-sentence-structure).

These are *systems*, not single-word exceptions — the hardest grammar in English because
there is no rule to memorize, only probabilities. World English replaces each
probabilistic system with one explicit rule.
...
and the simple/continuous/perfect choice rarely maps onto a learner's L1.

**Divergence & trade-off.** Loses the perfect's fine "past-with-present-relevance" nuance,
recovered with explicit time words (*already*, *since*, *still*). Trade subtlety for a rule
a beginner can apply.
...
**Rule.** Every noun can be counted and pluralized (by [morphology M4](morphology.md)).
The uncountable category is removed.

**Problem it solves.** The arbitrary, L1-dependent uncountable list (*information, advice,
furniture*) that blocks *informations*, *an advice* (see
